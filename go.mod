...
require (
	...
	k8s.io/cloud-provider v0.18.18
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.18.19-rc.0
...
replace k8s.io/kubectl => k8s.io/kubectl v0.18.18

replace k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.18.18

replace k8s.io/sample-controller => k8s.io/sample-controller v0.18.18
