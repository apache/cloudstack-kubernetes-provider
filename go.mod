...
require (
	...
	k8s.io/klog v1.0.0
	k8s.io/kubernetes v1.20.6 // indirect
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.20.7-rc.0
...
replace k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.20.6

replace k8s.io/sample-controller => k8s.io/sample-controller v0.20.6
